...
namespace K22CNT3_NKL_2210900035_Project2.Controllers
{
    public class QUAN_TRIController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ma_quan_tri,mat_khau,ten_dang_nhap,email,ngay_tao,trang_thai")] QUAN_TRI qUAN_TRI)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ma_quan_tri,mat_khau,ten_dang_nhap,email,ngay_tao,trang_thai")] QUAN_TRI qUAN_TRI)
        {
            if (ModelState.IsValid)
            {
